...
assert.match(app, /v11\.4\.4/);
assert.match(health, /version: "11\.4\.4"/);
...
console.log("✓ retained v11.3.5 features with v11.4.4 version badge, click-away popovers, blue controls, automatic FX reveal, saved-route toggle, program hover labels, and flexible cash-date checks passed");

...
assert.match(app, /v11\.3\.5/);
assert.match(health, /version: "11\.3\.5"/);
...
console.log("✓ v11.3.5 version badge, click-away popovers, blue controls, automatic FX reveal, saved-route toggle, program hover labels, and flexible cash-date checks passed");

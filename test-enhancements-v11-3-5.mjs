...
assert.match(app, /v11\.4\.5/);
assert.match(health, /version: "11\.4\.5"/);
...
console.log("✓ retained v11.3.5 features with v11.4.5 version badge, click-away popovers, blue controls, automatic FX reveal, saved-route toggle, program hover labels, and flexible cash-date checks passed");

...
console.log("✓ v11.4.3 retained-v11.3.7 regression checks passed: original controls retained, add-route moved, cash fares reused, and uploaded red-airplane favicon configured");
